                    ...
                    <ScrollView style={styles.container}>
                        ...
                        <Calendar
                            ...
                            dayComponent={({ date, state }) => {
                                return (<View style={{ flex: 1 }}><Text style={{
                                    textAlign: 'center',
                        ...
                        <Calendar
                            ...
                            markedDates={{
                                '2012-05-08': {
                                    ...
                                    }, { key: 'massage', color: 'red', selectedDotColor: 'white' } ], selected: true
                                },
                                '2012-05-09': {
                                    dots: [ {
                                        key: 'vacation',
                                    ...
                                    }, { key: 'massage', color: 'red', selectedDotColor: 'blue' } ], disabled: true
                                }
                            }}
                            hideArrows={false}
                        />
